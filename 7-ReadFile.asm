...
;First we need to create a section (.bss) (It can be found at the end of the file), which will contain the contents of the file that we want to print on the screen
